...
allBtn1.on('click', function () {
    ...
    shopBanner3.hide()
    shopBanner4.hide()
    $('.bannerText').html(`Our collection has been designed with timeless style and elegance in mind, to complement pieces you already own, resulting in a more mindful wardrobe that can take you from ‘coffee to cocktails’ with ease. Sustainability is at the heart of Sassi Holford - all our garments are made-to-order so every piece has a home, and are made in England to ensure that we keep our carbon footprint low and take responsibility for our impact on the planet.`)
})
